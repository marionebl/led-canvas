            ...
            value: function(str, size, x, y) {
                ...
                str.split('').forEach(function(char) {
                    ...
                    if (_this.cursor.x + _sign.width + charSpacing*2 > _this.matrix.x) {
                        _this.cursor = { x: charSpacing, y: _this.cursor.y + _this.font.meta.lineHeight + charSpacing*2 };
                    }
                    ...
                    _this.cursor.x += _this.font.meta.monospaced ? _this.font.meta.charWidth + charSpacing*2 : _sign.width + charSpacing*2;
                });
            }
        }
    });
